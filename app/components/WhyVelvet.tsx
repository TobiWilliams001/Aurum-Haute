    ...
    <section className="py-24 px-4 bg-burgundy-50 dark:bg-burgundy-900">
      <div className="max-w-4xl mx-auto text-center">
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-5xl md:text-6xl font-hammersmith mb-8 tracking-wide gradient-text"
        >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="text-2xl md:text-3xl mb-12 font-zingrust text-burgundy-800 dark:text-cream-200 italic"
        >
          "Velvet is bold. It commands attention—without saying a word."
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          Aurum Haute embraces texture, richness, and depth. Every bag is designed to be as luxurious to touch as it is
          to carry.
        </motion.p>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          {features.map((feature, index) => (
            ...
            >
              <p className="text-burgundy-800 dark:text-cream-100 font-zingsans text-lg">{feature}</p>
            </motion.div>
          ))}
        </div>
